...
namespace Geuneda.Services.Versioning.Editor
{
	...
	public static class VersionEditorUtils
	{
		...
		/// 없으면 <see cref="VersioningEditorSettings"/>에 설정된 폴더 경로를 반환합니다.
		/// 반환값은 프로젝트 루트 기준의 "Assets/..." 상대 경로입니다.
		/// </summary>
		private static string ResolveFilePath()
		{
			...
			return VersioningEditorSettings.instance.ResourcesFolderPath;
		}
		...
		{
			var relFolderPath = ResolveFilePath();
